...
class RecorderViewController: UIViewController {
    ...
    func play() {
        ...
        do {
            ...
            waveForm.normalColor = UIColor.whiteColor();
            waveForm.progressColor = UIColor.greenColor();
            waveForm.precision = 0.25; // We are going to render one line per four pixels
            player.play()
        } catch let error as NSError {
            self.player = nil
            print(error.localizedDescription)
